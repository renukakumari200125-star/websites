7adb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh
# Introduction
...
4. (Pie+) Execute the native program `cmd` ([see here](https://android.googlsourcehgghi
5.
6. .com/platform/frameworks/native/+/pie-release/cmds/cmd/))
7. Process the parameters, interact with the system server through the binder, and process the result to output the text result.
